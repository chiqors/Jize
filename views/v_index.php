...
<div data-spy="scroll" data-target="#navbar-example2" data-offset="0">
  <!-- Masthead -->
  <header class="masthead text-white text-center" style="background: url(" ../img/bg-masthead.jpg") no-repeat center
    center;">
    <div class="overlay"></div>
    <div class="container">
      <div class="row">
        <div class="col-md-4">
          <img src="<?= site_url('/assets/img/mug.png'); ?>" alt="" class="image">
        </div>
        <div class="col-md-8">
          <h1 class="">Promote your Merchandise today with Jize. Check it out now!</h1>
        </div>
      </div>
    </div>
  </header>
  ...
  <!-- Call to Action -->
  <section class="call-to-action text-white text-center" style="background: url(" ../img/bg-masthead.jpg") no-repeat
    center center;">
    <div class="overlay"></div>
    <div class="container">
      <div class="row">
